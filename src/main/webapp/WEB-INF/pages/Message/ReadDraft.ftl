...
<div class="Navs">
    <div class="nav_L left">
        <i class="fa fa-home">&nbsp;</i><span>信息系统</span> > <span>草稿箱</span>
    </div>
                ...
                <form class="form-horizontal" method="post" id="f1" name="f1" action="/Message/SendMail">
                    ...
                    <div class="mail-text h-200">
                        ...
                        <div class="summernote">
                            <textarea class="col-sm-10"
                                      style="height:150px;line-height: 80px;text-align: center; margin-left:120px;resize:none;"

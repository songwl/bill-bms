...
<script src="${ctx}/static/js/billManage/getStandardBill.js"></script>
<div class="Navs">
    <div class="nav_L left">
        <i class="fa fa-home">&nbsp;</i><span>数据统计</span> > <span>达标任务</span>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" id="list-panel">
            <div class="panel-body">
                <div class="panel-nav">
                    <div class="Nav_Left">&nbsp;<i class="fa fa-paper-plane"></i>&nbsp;达标任务</div>
                    <div class="Nav_Right">
                    </div>
                    <div class="cls"></div>
                </div>
